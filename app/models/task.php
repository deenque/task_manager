<?php
require_once '../config/database.php'; // Ваше подключение к БД
require_once '../app/models/task.php'; // Ваш класс Task
...
class Task {
    ...
    public function updateTitle($taskId, $newTitle) {
        ...
        if ($stmt->execute([$newTitle, $taskId])) {
            return true;
        } else {
            return false; // Или добавить обработку ошибок
        }
    }
